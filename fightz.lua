...
local function createGui()
   ...
   TitleLabel.TextScaled = true -- ✅ Auto-scales text
...
minimizeBtn.Size = UDim2.new(0, 30, 0, 30) -- Same height as TitleLabel
minimizeBtn.Position = UDim2.new(1, -30, 0, 0) -- Flush to right
